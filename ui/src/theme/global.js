...
import background from '../assets/images/background-restreamer.png';
...
export default {
	...
	body: {
		background: `${base.palette.background.button_disabled} url(${background}) no-repeat fixed center center`,
