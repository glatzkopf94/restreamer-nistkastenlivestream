...
import * as Timestamps from './video/Timestamps';
...
import * as TextOverlay from './video/TextOverlay';
...
videoRegistry.Register(Timestamps);
...
videoRegistry.Register(TextOverlay);
