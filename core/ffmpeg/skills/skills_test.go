...
func TestFilters(t *testing.T) {
	data := ` T. setpts            V->V       Set PTS for the output video frame.
 ...
 T.. alphamerge        VV->V      Copy the luma value of the second input into the alpha channel of the first input.`
	...
	require.Equal(t, []Filter{
		{
			Id:   "setpts",
			Name: "Set PTS for the output video frame.",
		},
		{
			Id:   "drawtext",
			Name: "Draw text on top of video frames using libfreetype library.",
		},
		{
			Id:   "afirsrc",
